        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Your trusted travel partner for discovering the royal heritage and
            ...
            <div className="flex items-center mb-2">
              ...
              <a href="tel:+919785560707" className="hover:text-primary">
                +91 97855 60707
              </a>
            </div>
            <div className="flex items-center">
              ...
              <a
                href="mailto:shreeshyamtravelsjaipur8@gmail.com"
                className="hover:text-primary min-w-0"
              >
                shreeshyamtravelsjaipur8@gmail.com
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Stay connected! Follow us on social media for updates, tips, and
              exclusive content.
            </p>
            <div className="flex space-x-4">
              {[
                {
                  name: "Facebook",
                  href: "https://www.facebook.com/sreesayamtourandtravels",
                  icon: "M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z",
                },
                {
                  name: "Instagram",
                  href: "https://www.instagram.com/sreesayamtourtarvels",
                  icon: "M16 4H8a4 4 0 00-4 4v8a4 4 0 004 4h8a4 4 0 004-4V8a4 4 0 00-4-4zm-4 11a3 3 0 110-6 3 3 0 010 6zm3.5-6a1 1 0 110-2 1 1 0 010 2z",
                },
              ].map((social) => (
                <a
                  key={social.name}
