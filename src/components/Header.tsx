      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-4">
              ...
              <div className="w-14 h-14 mr-3 relative">
                <svg viewBox="0 0 100 100" className="w-full h-full">
                  ...
                  <g transform="translate(15, 15) rotate(-25, 35, 35)">
                    <path d="M55 30 L70 25 L72 28 L60 35 L65 45 L62 46 L55 38 L45 42 L44 40 L52 35 L45 30 L46 28 Z" fill="url(#planeGrad)" />
                  </g>
                  
                  {/* Flight trail */}
                  <path d="M10 25 Q25 30 35 22" stroke="url(#trailGrad)" strokeWidth="3" fill="none" strokeLinecap="round" strokeDasharray="2 4" />
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <a href="tel:+919785560707" className="flex items-center text-primary font-semibold">
        ...
        {isMenuOpen && (
          <div className="lg:hidden pb-4">
            ...
            <a href="tel:+919785560707" className="block py-2 text-primary font-semibold">
              +91 97855 60707
            </a>
          </div>
        )}
